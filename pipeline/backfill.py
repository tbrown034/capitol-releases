...
HEADERS = {
    ...
    # Full Chrome 130 fingerprint added 2026-05-02 wave-3 after Akamai 403'd
    # mid-backfill on House subdomains. The recon scripts (pipeline/recon/
    # house_full_recon.py) use this same set and get past Akamai cleanly at
    # concurrency 3; the bare Mozilla UA gets blocked. See memory
    # `project_house_phase_b1` for the concurrency-3 + Chrome-130 finding.
    "Accept": (
